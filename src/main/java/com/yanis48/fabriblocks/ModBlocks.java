...
public class ModBlocks {
	...
	public static void init() {
		SNOW_BRICKS = new FBBlock("snow_bricks", 2.0f, 30.0f);
		SNOW_BRICK_STAIRS = new FBStairs(SNOW_BRICKS.getDefaultState(), "snow_brick_stairs", 2.0f, 30.0f);
		SNOW_BRICK_SLAB = new FBSlab("snow_brick_slab", 2.0f, 30.0f);
