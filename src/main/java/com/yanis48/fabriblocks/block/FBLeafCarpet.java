...
public class FBLeafCarpet extends Block {
	...
	public FBLeafCarpet(String name) {
		super(FabricBlockSettings.of(Material.PART, MaterialColor.FOLIAGE).sounds(BlockSoundGroup.GRASS).strength(0.2f, 1.0f).noCollision().nonOpaque().build());
	...
	public BlockState getStateForNeighborUpdate(BlockState state_1, Direction direction, BlockState state_2, IWorld world, BlockPos pos_1, BlockPos pos_2) {
